            ...
            <div class="spacer">
              &nbsp;
                ...
                <%
                    ...
                    ArrayList<Object> cart = (new ShoppingCartItemRequest()).getShoppingCartItems(userID);
                    int count = 0;
                    
                    // print all items in cart
                    for (Object cart_item: cart) {
                        ...
                        if (count != 0) {
                            ...
                            out.print("<br />");
                            out.print("<p> ID: " + ((ShoppingCartItem)cart_item).getItemID() + "</p>");
                ...
                <form method="post" action="ShoppingCart">
                    ...
                    <p>Remove Item from wish list<input type="submit" name="deleteItem" value="remove"/></p>
                    
                </form>
                <form method="get" actions="checkout.jsp">
                    <p><input type="submit" name="checkout" value="Check Out" />
                </form>
