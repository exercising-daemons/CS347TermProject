...
public class ShoppingCartServlet extends HttpServlet {
  ...
  public void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    if (request.getParameter("addItem") != null) {
      ...
      forwardRequest(request, response, "/shoppingCart.jsp");
    }    
  ...
  /**
   * handles adding an item(s) to the current user's shopping cart
   * @param request
   * @param response
   * @throws IOException
  ...
  private void handleAddItem(HttpServletRequest request,
    ...
    ShoppingCartItemUpdate cartUpdate = new ShoppingCartItemUpdate();
    itemAdded = cartUpdate.addShoppingCartItem(userID, itemID, quantity);
  ...
  /**
   * handles deleting an item from the current user's shopping cart
   * @param request
   * @param response
   * @throws IOException
   * @throws ServletException 
   */
   private void handleDeleteItem(HttpServletRequest request,
    ...
    ShoppingCartItemUpdate cartUpdate = new ShoppingCartItemUpdate();
    itemDeleted = cartUpdate.removeShoppingCartItem(userID, itemID);
